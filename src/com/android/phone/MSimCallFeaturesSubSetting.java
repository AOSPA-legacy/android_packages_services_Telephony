...
public class MSimCallFeaturesSubSetting extends CallFeaturesSetting {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mVibrateCallWaitingPref = (CheckBoxPreference) findPreference(BUTTON_VIBRATE_CALL_WAITING_KE
Y);
        ...
        mVibrateCallWaitingPref.setChecked(prefs.getBoolean(mVibrateCallWaitingPref.getKey(), initia
lState));
